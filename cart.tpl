...
<div class="container"><?php echo $column_left; ?><?php echo $column_right; ?>
  <div id="content"><?php echo $content_top; ?>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="quantity"><input style="min-width:10px;"type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="3" /></td>
    ...
    <div class="buttons">
      ...
      <div class="right" id="jright" ss="<?php echo $_SESSION['ss'];?>"><a href="<?php echo $checkout; ?>" class="button"><span><?php echo $button_checkout; ?></span></a></div>
