...
<link rel="stylesheet" type="text/css" href="style/index_s.css" />
...
<script type="text/javascript" src="catalog/view/javascript/index_s.js"></script>
...
<div id="header">
   <div class="topnav">
        ...
        <div class="links">
  <a href="http://www.365hehe.com/index_s.html"><?php echo $text_home; ?></a>
  ...
  <img src="catalog/view/theme/default/image/ntoph.png" class="ntoph" />
  ...
  <ul>
    ...
    <?php } ?>
        ...
        <div class="nav" id="nav">
            <ul>
                <li><a href="index_s.html">首页</a></li>
                <li><a href="index.php?route=account/login">我的合合网</a></li>
                <li><a href="about.html">关于合合网</a></li>
                <li><a href="brandtype.html">品牌种类</a></li>
                <li><a href="welfare.html">福利团购</a></li>
                <li><a href="businessgifts.html">商务礼品</a></li>
                <li><a href="promotions.html">优惠活动</a></li>
                <li><a href="help.html">帮助中心</a></li>
                <li style="margin:0 0 0 5%;"><a href="pdf/qyfyydfa.pdf">福利解决方案</a></li>
            </ul>
        </div>
