...
(function($){
    $.fn.yxMobileSlider = function(settings){
        ...
        return this.each(function(){
            ...
            var oFocusContainer = $(".focus", $(this));
            for (var i = 0; i < num; i++) {
            ...
            oFocusContainer.css({
                ...
                display: settings.focus?'block':'none'
            })
            ...
            $("div", oFocusContainer).width(oFocus.outerWidth(true) * num+2).css({
                position: 'absolute',
                right: '45%',
                bottom: 0,
