...
function() {
    ...
    var e = function(e, t, n, i) {
        var o = {
            ...
            detectFeatures: function() {
                ...
                if (i.oldIE = document.all && !document.addEventListener, i.touch = "ontouchstart" in window, window.requestAnimationFrame && (i.raf = window.requestAnimationFrame, i.caf = window.cancelAnimationFrame), i.pointerEvent = navigator.pointerEnabled || navigator.msPointerEnabled, !i.pointerEvent) {
                    ...
                    s = l ? l[1] : 0;
                    s = parseFloat(s),
                    s >= 1 && (4.4 > s && (i.isOldAndroid = !0), i.androidVersion = s),
        ...
        Vt = function(e, t) {
            if (!s.loop && t) {
                ...
                i = Math.round(e - In.x); (0 > n && i > 0 || n >= vt() - 1 && 0 > i) && (e = In.x + i * s.mainScrollEndFriction)
            }
            In.x = e,
            Bt(e, p)
        },
        ...
        $t = function() {
            ...
            s.mouseUsed || o.bind(document, "mousemove", Qt),
        ...
        jt = function() {
            ...
            o.unbind(document, "mousemove", Qt),
            X && o.unbind(window, h, a),
            zt("unbindEvents")
        },
        Jt = null,
        Qt = function() {
            Jt && (o.unbind(document, "mousemove", Qt), o.addClass(e, "pswp--has_mouse"), s.mouseUsed = !0, zt("mouseUsed")),
        ...
        un = function(t, n, i, a) {
            ...
            var l = function() {
                an("initialZoom"),
                i || (_t(1), n && (n.style.display = "block"), o.addClass(e, "pswp--animated-in"), zt("initialZoom" + (i ? "OutEnd": "InEnd"))),
                a && a(),
                ht = !1
            },
            ...
            return r && void 0 !== r.x && u ? (t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), i || (x = r.w / t.w, Dt.x = r.x, Dt.y = r.y - L, s.showHideOpacity && (e.style.opacity = .001, e.style.webkitBackfaceVisibility = "hidden"), Ht()), rn("initialZoom"), i && !d && o.removeClass(e, "pswp--animated-in"), U = setTimeout(function() {
                if (zt("initialZoom" + (i ? "Out": "In")), i) {
                    ...
                    p = ct,
                    f = function(t) {
                        D && (m = o.getScrollY(), D = !1),
                        1 === t ? (x = n, Dt.x = r.x, Dt.y = r.y - m, d && l()) : (x = (n - c) * t + c, Dt.x = (r.x - a.x) * t + a.x, Dt.y = (r.y - m - a.y) * t + a.y),
                        Ht(),
                        s.showHideOpacity ? e.style.opacity = 1 - t: _t(p - t * p)
                    };
                    d ? sn("initialZoom", 0, 1, u, o.easing.cubic.out, f) : (f(1), U = setTimeout(l, u + 20))
                } else x = t.initialZoomLevel,
                qt(Dt, t.initialPosition),
                Ht(),
                _t(1),
                s.showHideOpacity ? e.style.opacity = 1 : _t(1),
                U = setTimeout(l, u + 20)
            },
        ...
        cn = {
            ...
            init: function() {
                if (!u && !c) {
                    ...
                    v = {
                        ...
                        scroll: function() {
                            D = !0,
                            s.closeOnScroll && u && (!a.likelyTouchDevice || s.mouseUsed) && Math.abs(o.getScrollY() - L) > 2 && (d = !0, a.close())
                        },
                        keydown: function(e) {
                            T = "",
                    ...
                    v[S] = Bn,
                    A && (v[A] = v[S]),
                    _.touch && (y += " mousedown", h += " mousemove mouseup", v.mousedown = v[M], v.mousemove = v[Z], v.mouseup = v[S]),
                    zt("firstUpdate"),
                    m = m || s.index || 0,
                    (isNaN(m) || 0 > m || m >= vt()) && (m = 0),
                    a.currItem = yt(m),
                    (_.isOldIOSPhone || _.isOldAndroid) && (kt = !1),

                    s.modal && (e.setAttribute("aria-hidden", "false"), kt ? e.style.position = "fixed": (e.style.position = "absolute", e.style.top = o.getScrollY() + "px")),
                    void 0 === N && (zt("initialLayout"), N = L = o.getScrollY());
                    var U = "pswp--open ";
                    ...
                    Lt("initialZoomInEnd",
                    function() {
                        a.setContent(C[0], m - 1),
                        a.setContent(C[2], m + 1),
           ...
           document.querySelector('.my-simple-gallery').style.display = "block";
		   //alert(4);
		    },
            destroy: function() {
                zt("destroy"),
                U && clearTimeout(U),
                s.modal && (e.setAttribute("aria-hidden", "true"), e.className = P),
                I && clearInterval(I),
            ...
            panTo: function(e, t, n) {
                n || (e > it.min.x ? e = it.min.x: it.max.x > e && (e = it.max.x), t > it.min.y ? t = it.min.y: it.max.y > t && (t = it.max.y)),
                Dt.x = e,
                Dt.y = t,
                Ht()
            },
            ...
            updateCurrZoomItem: function(e) {
                ...
                g = x = a.currItem.initialZoomLevel,
                Dt.x = it.center.x,
                Dt.y = it.center.y,
                e && zt("afterChange")
            },
            ...
            updateSize: function(t) {
                if (!kt) {
                    ...
                    Et.x = window.innerWidth,
                    Et.y = window.innerHeight,
                    e.style.height = Et.y + "px"
                }
                if (Tt.x = a.scrollWrap.clientWidth, Tt.y = a.scrollWrap.clientHeight, lt = {
                    x: 0,
                    y: N
                },
                St.x = Tt.x + Math.round(Tt.x * s.spacing), St.y = Tt.y, Vt(St.x * Mt), zt("beforeResize"), void 0 !== f) for (var i, r, u = 0; l > u; u++) i = C[u],
                Bt((u + f) * St.x, i.el.style),
                r = yt(i.index),
                r.needsUpdate && (a.cleanSlide(r), a.setContent(i, i.index), 1 === u && a.updateCurrZoomItem(!0), r.needsUpdate = !1),
                r && r.container && (Jn(r, Tt), Yt(r));
                g = x = a.currItem.initialZoomLevel,
                it = a.currItem.bounds,
                it && (Dt.x = it.center.x, Dt.y = it.center.y, Ht()),
            ...
            zoomTo: function(e, t, n, i, a) {
                ...
                c = function(t) {
                    1 === t ? (x = e, Dt.x = l.x, Dt.y = l.y) : (x = (e - s) * t + s, Dt.x = (l.x - u.x) * t + u.x, Dt.y = (l.y - u.y) * t + u.y),
                    a && a(t),
                    Ht()
                };
        ...
        Cn = gt(),
        Tn = function(e, t) {
            return bn.x = Math.abs(e.x - t.x),
            bn.y = Math.abs(e.y - t.y),
            Math.sqrt(bn.x * bn.x + bn.y * bn.y)
        },
        Mn = function() {
            j && (F(j), j = null)
        },
        ...
        An = {},
        kn = function(e, t) {
            return An.prevent = "A" !== e.target.tagName,
            zt("preventDragEvent", e, t, An),
            An.prevent
        },
        On = function(e, t) {
            return t.x = e.pageX,
        ...
        Nn = function(e) {
            ...
            return O ? (mt = 0, xn.forEach(function(e) {
                0 === mt ? zn[0] = e: 1 === mt && (zn[1] = e),
                mt++
            })) : e.type.indexOf("touch") > -1 ? e.touches && e.touches.length > 0 && (zn[0] = On(e.touches[0], Pn), e.touches.length > 1 && (zn[1] = On(e.touches[1], Ln))) : (Pn.x = e.pageX, Pn.y = e.pageY, Pn.id = "", zn[0] = Pn),
            zn
        },
        _n = function(e, t) {
            var n, i, o = 0,
            ...
            u = In.x + t.x,
            c = In.x - gn.x;
            n = r > it.min[e] || it.max[e] > r ? s.panEndFriction: 1,
            r = Dt[e] + t[e] * n;
            var d, m;
        ...
        Un = function(e) {
            ...
            if (!G || "mousedown" !== e.type) {
                ...
                Q = null,
                ln(),
                X && 1 !== i || (X = st = !0, o.bind(window, h, a), V = dt = ut = W = J = $ = K = q = !1, rt = null, zt("firstTouchStart", n), qt(It, Dt), bt.x = bt.y = 0, qt(yn, n[0]), qt(vn, yn), gn.x = St.x * Mt, wn = [{
                    x: yn.x,
                    y: yn.y
                }], Y = H = Nt(), en(x, !0), Mn(), Zn()),
                !et && i > 1 && !at && !J && (g = x, q = !1, et = K = !0, bt.y = bt.x = 0, qt(It, Dt), qt(pn, n[0]), qt(fn, n[1]), En(pn, fn, Cn), Dn.x = Math.abs(Cn.x) - Dt.x, Dn.y = Math.abs(Cn.y) - Dt.y, tt = nt = Tn(pn, fn))
            }
        },
        Hn = function(e) {
            ...
            if (Q) {
                ...
                if (0 !== e) if (qt(pn, Q[0]), hn.x = pn.x - yn.x, hn.y = pn.y - yn.y, et && e > 1) {
                    ...
                    if (a.currItem.minZoom > n) if (s.pinchToClose && !dt && a.currItem.initialZoomLevel >= g) {
                        ...
                        zt("onPinchClose", r),
                        ut = !0
                    } else i = (a.currItem.minZoom - n) / a.currItem.minZoom,
                    i > 1 && (i = 1),
                    n = a.currItem.minZoom - i * (a.currItem.minZoom / 3);
        ...
        Bn = function(e) {
            ...
            if (0 === s && (X = !1, o.unbind(window, h, a), Mn(), et ? u = 0 : -1 !== wt && (u = Nt() - wt)), wt = 1 === s ? Nt() : -1, r = -1 !== u && 150 > u ? "zoom": "swipe", et && 2 > s && (et = !1, 1 === s && (r = "zoomPointerUp"), zt("zoomGestureEnded")), Q = null, $ || q || at || W) if (ln(), B || (B = Vn()), B.calculateSwipeSpeed("x"), W) {
                ...
                if (.6 > c) a.close();
                    ...
                    var d = Dt.y,
                    m = ct;
                    sn("verticalDrag", 0, 1, 300, o.easing.cubic.out,
                    function(e) {
                        Dt.y = (a.currItem.initialPosition.y - d) * e + d,
                        _t((1 - m) * e + m),
                        Ht()
                    }),
                    zt("onVerticalDrag", 1)
        ...
        Vn = function() {
            var e, t, n = {
                ...
                calculateSwipeSpeed: function(i) {
                    wn.length > 1 ? (e = Nt() - Y + 50, t = wn[wn.length - 2][i]) : (e = Nt() - H, t = vn[i]),
                    n.lastFlickOffset[i] = yn[i] - t,
                    n.lastFlickDist[i] = Math.abs(n.lastFlickOffset[i]),
                    n.lastFlickSpeed[i] = n.lastFlickDist[i] > 20 ? n.lastFlickOffset[i] / e: 0,
                    .1 > Math.abs(n.lastFlickSpeed[i]) && (n.lastFlickSpeed[i] = 0),
        ...
        Wn = function(e) {
            ...
            e.backAnimStarted = {},
            .05 >= Math.abs(e.lastFlickSpeed.x) && .05 >= Math.abs(e.lastFlickSpeed.y) ? (e.speedDecelerationRatioAbs.x = e.speedDecelerationRatioAbs.y = 0, e.calculateOverBoundsAnimOffset("x"), e.calculateOverBoundsAnimOffset("y"), !0) : (rn("zoomPan"), e.lastNow = Nt(), e.panAnimLoop(), void 0)
        },
        Gn = function(e, t) {
            var n;
            at || (Zt = m);
            ...
            var u, c = St.x * Mt,
            d = Math.abs(c - In.x);
            return n || c > In.x == t.lastFlickSpeed.x > 0 ? (u = Math.abs(t.lastFlickSpeed.x) > 0 ? d / Math.abs(t.lastFlickSpeed.x) : 333, u = Math.min(u, 400), u = Math.max(u, 250)) : u = 333,
            Zt === m && (n = !1),
            at = !0,
            sn("mainScroll", In.x, c, u, o.easing.cubic.out, Vt,
            function() {
                ln(),
                at = !1,
                Zt = -1,
                (n || Zt !== m) && a.updateCurrItem(),
        ...
        Jn = function(e, t, n) {
            if (e.src) {
                ...
                if (i && (e.vGap || (e.vGap = {
                    ...
                    e.fillRatio = o > a ? o: a;
                    var r = s.scaleMode;
                    "orig" === r ? n = 1 : "fit" === r ? n = e.fitRatio: "fill" === r && (n = e.fillRatio),
                    n > 1 && (n = 1),
                    e.initialZoomLevel = n,
                    e.maxZoom = 2,
                    e.doubleTapZoom = 2 * n > 1 ? 2 * n: 1,
                    e.minZoom = n,
                    e.bounds || (e.bounds = {
                        center: {},
                        max: {},
                ...
                qn.y = e.h * n;
                var l = e.bounds;
                return l.center.x = Math.round((Kn.x - qn.x) / 2),
                l.center.y = Math.round((Kn.y - qn.y) / 2) + e.vGap.top,
                l.max.x = qn.x > Kn.x ? Math.round(Kn.x - qn.x) : l.center.x,
                l.max.y = qn.y > Kn.y ? Math.round(Kn.y - qn.y) + e.vGap.top: l.center.y,
                l.min.x = qn.x > Kn.x ? 0 : l.center.x,
                l.min.y = qn.y > Kn.y ? e.vGap.top: l.center.y,
                i && n === e.initialZoomLevel && (e.initialPosition = l.center),
                l
            }
            return ! 1
        },
        Qn = function(e, t, n, i, o, r) {
            var l; ! o && (E || s.alwaysFadeIn) && (e === m || a.isMainScrollAnimating() || a.isDragging() && !a.isZooming()) && (l = !0),
            i && (l && (i.style.opacity = 0), t.imageAppended = !0, n.appendChild(i), l && setTimeout(function() {
                i.style.opacity = 1,
        ...
        ni = function() {
            if ($n.length) {
                for (var e, t = 0; $n.length > t; t++) e = $n[t],
                e.holder.index === e.index && Qn(e.index, e.item, e.baseDiv, e.img);
                $n = []
            }
        };
        Rt("Controller", {
            publicMethods: {
                lazyLoadItem: function(e) {
                    e = Ft(e);
                    var t = yt(e); ! t || t.loaded || t.loading || (zt("gettingData", e, t), ei(t))
                },
                initController: function() {
                    ...
                    function(e) {
                        ...
                        o = Math.min(n[0], vt()),
                        r = Math.min(n[1], vt());
                        for (t = 1; (i ? r: o) >= t; t++) a.lazyLoadItem(m + t);
                        for (t = 1; (i ? o: r) >= t; t++) a.lazyLoadItem(m - t)
                    }),
                    Lt("initialLayout",
                    function() {
                        a.currItem.initialLayout = s.getThumbBoundsFn && s.getThumbBoundsFn(m)
                    }),
                    Lt("mainScrollAnimComplete", ni),
                    Lt("initialZoomInEnd", ni),
                    Lt("destroy",
                    function() {
                        for (var e, t = 0; pt.length > t; t++) e = pt[t],
                ...
                setContent: function(e, t) {
                    ...
                    if (r) {
                        if (zt("gettingData", t, r), e.index = t, e.item = r, ti(r, e)) return r.initialPosition.x = r.initialPosition.y = 0,
                        r.initialZoomLevel = r.maxZoom = r.minZoom = 1,
                        ot = null,
                        r.w = 50,
                        r.h = 50,
                        Yt(r),
                        ...
                        if (r.loaded) i = o.createEl("pswp__img", "img"),
  ...
  //var c = o.createEl("pswp__img pswp__img--placeholder" + (r.msrc ? "": " pswp__img--placeholder--blank"), r.msrc ? "img": "");
                            ...
                            r.loading || ei(r),
                            a.allowProgressiveImg() && (ft ? Qn(t, r, l, r.img, !0, !0) : $n.push({
                                item: r,
                                baseDiv: l,
                                img: r.img,
                                index: t,
                        ...
                        Jn(r, Tt),
                        ft || t !== m ? Yt(r) : (ot = l.style, un(r, i || r.img)),
                        e.el.innerHTML = "",
                        e.el.appendChild(l)
                    } else e.el.innerHTML = ""
                },
        ...
        Rt("Tap", {
            publicMethods: {
                initTap: function() {
                    Lt("firstTouchStart", a.onTapStart),
                    Lt("touchRelease", a.onTapRelease),
                    Lt("destroy",
                    function() {
                        oi = {},
                        ii = null
                ...
                onTapRelease: function(e, t) {
                    if (t && !$ && !K && !on) {
                        var n = t;
                        if (ii && (clearTimeout(ii), ii = null, Kt(n, oi))) return zt("doubleTap", n),
                        void 0;
                        var i = e.target.tagName.toLowerCase();
                        if ("mouse" === t.type) return ai(e, t, "mouse"),
                        void 0;
                        if ("button" === i || o.hasClass(e.target, "pswp__single-tap")) return ai(e, t),
                        void 0;
                        qt(oi, n),
        ...
        Rt("DesktopZoom", {
            publicMethods: {
                handleMouseWheel: function(e) {
                    ...
                    if (e.preventDefault(), e.stopPropagation(), ri.x = 0, "deltaX" in e) ri.x = e.deltaX,
                    ri.y = e.deltaY;
                    else if ("wheelDelta" in e) e.wheelDeltaX && (ri.x = -.16 * e.wheelDeltaX),
                    ri.y = e.wheelDeltaY ? -.16 * e.wheelDeltaY: -.16 * e.wheelDelta;
                    else {
                        if (! ("detail" in e)) return;
                        ri.y = e.detail
                    }
                    en(x, !0),
                    a.panTo(Dt.x - ri.x, Dt.y - ri.y)
                },
                toggleDesktopZoom: function(t) {
                    ...
                    var n = 1 === x;
                    a.mouseZoomedIn = !n,
                    a.zoomTo(n ? a.currItem.initialZoomLevel: 1, t, 333),
                ...
                setupDesktopZoom: function(t) {
                    ...
                    var i, r = function() {
                        ...
                        1 > x ? o.addClass(e, "pswp--zoom-allowed") : o.removeClass(e, "pswp--zoom-allowed"),
                        l()
                    },
                    l = function() {
        ...
        Ii = function() {
            if (ui && clearTimeout(ui), on || X) return ui = setTimeout(Ii, 500),
            void 0;
            ...
            publicMethods: {
                initHistory: function() {
                    if (o.extend(s, xi, !0), s.history) {
                        ...
                        pi = gi(),
                        pi.indexOf("gid=") > -1 && (pi = pi.split("&gid=")[0], pi = pi.split("?gid=")[0]),
                        Lt("afterChange", a.updateURL),
                        Lt("unbindEvents",
                        function() {
                        ...
                        var e = function() {
                            mi = !0,
                            hi || (yi ? history.back() : pi ? vi.hash = pi: "pushState" in history ? history.pushState("", document.title, vi.pathname + vi.search) : vi.hash = ""),
                            wi()
                        };
                        Lt("unbindEvents",
                        function() {
                        ...
                        t > -1 && (pi = pi.substring(0, t), "&" === pi.slice( - 1) && (pi = pi.slice(0, -1))),
                        setTimeout(function() {
