...
function() {
    ...
    var e = function(e, t) {
        ...
        E = function() {
            return b = !b,
            b ? (t.removeClass(s, "pswp__share-modal--fade-in"), setTimeout(function() {
        ...
        _ = function() {
            for (var t, n, o = "",
            i = 0; e.options.shareButtons.length > i; i++) t = e.options.shareButtons[i],
            n = t.url.replace("{{url}}", encodeURIComponent(window.location.href)).replace("{{image_url}}", encodeURIComponent(e.currItem.src || "")).replace("{{raw_image_url}}", e.currItem.src || "").replace("{{text}}", encodeURIComponent(e.currItem.title || "")),
            o += '<a href="' + n + '" target="_blank" class="pswp__share--' + t.id + '"' + (t.download ? "download": "") + ">" + t.label + "</a>";
            s.children[0].innerHTML = o,
            s.children[0].onclick = D
        },
        M = function(n) {
        ...
        x.init = function() {
            ...
            r("beforeChange", x.update),
            r("doubleTap",
            function(t) {
                var n = e.currItem.initialZoomLevel;
                e.getZoomLevel() !== n ? e.zoomTo(n, t, 333) : e.zoomTo(e.currItem.doubleTapZoom, t, 333)
            }),
            e.options.timeToIdle && r("mouseUsed",
            function() {
                t.bind(document, "mousemove", S),
                t.bind(document, "mouseout", k),
            ...
            function() {
                b || E(),
                v && clearInterval(v),
                t.unbind(document, "mouseout", k),
                t.unbind(document, "mousemove", S),
                t.unbind(o, "pswpTap click", C),
                t.unbind(e.scrollWrap, "pswpTap", x.onGlobalTap),
                t.unbind(e.scrollWrap, "mouseover", x.onMouseOver),
                n && (t.unbind(document, n.eventK, x.updateFullscreen), n.isFullscreen() && (I.hideAnimationDuration = 0, n.exit()), n = null)
            }),
            r("destroy",
            function() {
                e.options.captionEl && (a && o.removeChild(a), t.removeClass(i, "pswp__caption--empty")),
            ...
            var c, d, p, f = function(n) {
                ...
                i = 0; o > i; i++) {
                    c = n[i],
                    d = c.className;
                    for (var a = 0; Z.length > a; a++) p = Z[a],
                    d.indexOf("pswp__" + p.name) > -1 && (e.options[p.option] ? (t.removeClass(c, "pswp__element--disabled"), p.onInit && p.onInit(c)) : t.addClass(c, "pswp__element--disabled"))
                }
            };
            f(o.children),
			//alert(2);
document.querySelector('.my-simple-gallery').style.display = "none";
//alert(3);
            f(o.children[0].children),
            e.options.shareEl && l && s && (b = !0),
            e.options.fullscreenEl && (n || (n = x.getFullscreenAPI()), n ? (t.bind(document, n.eventK, x.updateFullscreen), x.updateFullscreen(), t.addClass(e.template, "pswp--supports-fs")) : t.removeClass(e.template, "pswp--supports-fs")),
            e.options.preloaderEl && (O(!0), r("beforeChange",
            function() {
                clearTimeout(m),
        ...
        x.onGlobalTap = function(n) {
            ...
            if (!f) if (n.detail && "mouse" === n.detail.pointerType) M(o) && e.close(),
            t.hasClass(o, "pswp__img") && (1 === e.getZoomLevel() && e.getZoomLevel() <= e.currItem.fitRatio ? e.close() : e.toggleDesktopZoom(n.detail.releasePoint));
            else if (e.options.tapToToggleControls && (g ? x.hideControls() : x.showControls()), e.options.tapToClose && (t.hasClass(o, "pswp__img") || M(o))) return e.close(),
            void 0
        },
        ...
        x.getFullscreenAPI = function() {
            ...
            t && (t.enter = function() {
                return u = e.options.closeOnScroll,
                e.options.closeOnScroll = !1,
                "webkitRequestFullscreen" !== this.enterK ? e.template[this.enterK]() : (e.template[this.enterK](Element.ALLOW_KEYBOARD_INPUT), void 0)
            },
            t.exit = function() {
                return e.options.closeOnScroll = u,
                document[this.exitK]()
            },
